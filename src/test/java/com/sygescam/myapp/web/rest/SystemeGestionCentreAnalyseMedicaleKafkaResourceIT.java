...
import com.sygescam.myapp.config.KafkaProperties;
...
class SystemeGestionCentreAnalyseMedicaleKafkaResourceIT {
    ...
    void setup() {
        ...
        SystemeGestionCentreAnalyseMedicaleKafkaResource kafkaResource = new SystemeGestionCentreAnalyseMedicaleKafkaResource(
            kafkaProperties
        );
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/systeme-gestion-centre-analyse-medicale-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/systeme-gestion-centre-analyse-medicale-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
