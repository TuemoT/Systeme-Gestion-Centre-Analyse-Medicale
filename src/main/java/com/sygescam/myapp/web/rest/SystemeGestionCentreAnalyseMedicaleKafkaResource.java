...
@RestController
@RequestMapping("/api/systeme-gestion-centre-analyse-medicale-kafka")
public class SystemeGestionCentreAnalyseMedicaleKafkaResource {
    private final Logger log = LoggerFactory.getLogger(SystemeGestionCentreAnalyseMedicaleKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SystemeGestionCentreAnalyseMedicaleKafkaResource(KafkaProperties kafkaProperties) {
